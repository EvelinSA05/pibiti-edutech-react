...
function RegistrationPage(props) {
    const { packagesData, featureTitle, titleHistory, desc1, desc2, harga1, desc3, desc4, harga2, desc5, harga3, titleForm, form1, form2, form3, send } = props;
    ...
    const handleSubmit = (event) => {
        ...
        alert(`Pendaftaran untuk kursus "${course.title}" telah berhasil! Anda akan diarahkan ke halaman utama.`);
        navigate('/');
    };

    if (!course) {
        return <div className="text-center py-20 text-2xl">{notFound}</div>;
    }
                ...
                <div className="form-container bg-gray-50 dark:bg-pink-800 p-8 rounded-lg shadow-lg">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input type="text" id="name" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500" required />
                        </div>
                        <div>
                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-white text-left">{form2}</label>
                            <input type="email" id="email" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500" required />
                        </div>
                        <div>
                            <label htmlFor="phone" className="block mb-2 text-sm font-medium text-white text-left">{form3}</label>
                            <input type="tel" id="phone" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500" required />
                        </div>
                        <div className="text-center pt-4">
                            <button type="submit" className="w-full px-8 py-3 bg-pink-700 text-white font-bold rounded-lg hover:bg-pink-600 transition-colors duration-300">
                                {send}
                            </button>
                        </div>
                    </form>
