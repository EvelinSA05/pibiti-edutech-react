...
const packagesData = [
  {
    id: "paket-belajar-pemrograman-dasar",
    title: "Paket Belajar Pemrograman Dasar",
    picture: "https://contentstatic.techgig.com/photo/msid-84838745,width-400,resizemode-4/A-brief-guide-for-coders-to-understand-the-programming-paradigms.jpg",
    harga: "Rp 500.000",
    fitur: [
  ...
  {
    id: "paket-belajar-pemrograman-lanjut",
    title: "Paket Belajar Pemrograman Lanjut",
    picture: "https://yukcoding.id/wp-content/uploads/2021/12/programming-coding.jpg",
    harga: "Rp 1.200.000",
    fitur: [
      "Konsep Pemrograman Berorientasi Objek (OOP)",
      "Pengembangan Web dengan API",
      "Manajemen Database (SQL & NoSQL)",
      "Prinsip Desain Perangkat Lunak",
      "Studi Kasus: Membangun Aplikasi Web"
    ]
  },
  {
    id: "paket-belajar-pemrograman-spesialis",
    title: "Paket Belajar Pemrograman Spesialis",
    picture: "https://www.techslang.com/wp-content/uploads/2023/09/learn-programming-language-scaled-e1695915051727.jpg",
    harga: "Rp 2.500.000",
    fitur: [
      "Spesialisasi Mobile Development (Android/iOS)",
      "Spesialisasi Machine Learning",
  ...
  {
    id: "paket-belajar-bisnis-lanjut",
    title: "Paket Belajar Pemrograman Spesialis",
    picture: "https://www.techslang.com/wp-content/uploads/2023/09/learn-programming-language-scaled-e1695915051727.jpg",
    harga: "Rp 2.500.000",
    fitur: [
...
const mentorsData = [
  {
    title: "Mentor Anna", description: "Mentor Pemrograman",
    picture: "https://static.promediateknologi.id/crop/0x0:0x0/0x0/webp/photo/p2/01/2025/01/08/6-Rahasia-Menjadi-Seorang-yang-Murah-Senyum-dan-Disukai-Banyak-Orang-2673540605.jpg",
    fitur: [
      "Pengenalan Algoritma & Struktur Data",
      "Variabel, Tipe Data, dan Operator",
  ...
  {
    title: "Mentor Budi", description: "Mentor Sosial",
    picture: "https://media.istockphoto.com/id/1485546774/id/foto/pria-botak-tersenyum-ke-kamera-berdiri-dengan-tangan-disilangkan.jpg?s=612x612&w=0&k=20&c=hzlkB5Rs5GS080SS5QU9e3pzweE4CIdRjbaMK-G25XQ=",
    fitur: [
      "Pengenalan Algoritma & Struktur Data",
      "Variabel, Tipe Data, dan Operator",
  ...
  {
    title: "Mentor Citra", description: "Mentor Science",
    picture: "https://media.sukabumiupdate.com/media/2023/11/20/1700456008_655ae6485debe_U7NMyDfBw4DOQBiPSYmJ.webp",
    fitur: [
      "Pengenalan Algoritma & Struktur Data",
      "Variabel, Tipe Data, dan Operator",
  ...
  {
    title: "Mentor Citra", description: "Mentor Content",
    picture: "https://media.sukabumiupdate.com/media/2023/11/20/1700456008_655ae6485debe_U7NMyDfBw4DOQBiPSYmJ.webp",
    fitur: [
      "Pengenalan Algoritma & Struktur Data",
      "Variabel, Tipe Data, dan Operator",
  ...
  {
    title: "Mentor Citra", description: "Mentor Bisnis",
    picture: "https://media.sukabumiupdate.com/media/2023/11/20/1700456008_655ae6485debe_U7NMyDfBw4DOQBiPSYmJ.webp",
    fitur: [
      "Pengenalan Algoritma & Struktur Data",
      "Variabel, Tipe Data, dan Operator",
...
function App() {
  ...
  return (
    <div className={theme === 'light' ? 'bg-[#eee6e8]' : 'bg-gray-900'}>
      <Navbar
        nav1="Home"
        nav2="Courses"
        nav3="Mentors"
      ...
      <main>
        <Routes>
          ...
          <Route path="/courses" element={<CoursesPage packagesData={packagesData} />} />
          <Route path="/course/:courseId" element={
            <CourseDetailPage
              packagesData={packagesData}
              notFound="404 - Kursus Tidak Ditemukan"
              back="Kembali ke Daftar Kursus"
              feature="Fitur yang Didapat:"
              regist="Daftar Paket Ini" />} />
          <Route path="/register/:courseId" element={
            <RegistrationPage
              packagesData={packagesData}
          ...
          <Route path="/mentors" element={<MentorsPage mentorsData={mentorsData} />} />
      ...
      <Footer
        ...
        d1="Kursus Online" d2="Kursus Tatap Muka"
        d3="Discord" d4="Instagram"
