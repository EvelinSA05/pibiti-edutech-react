...
function Navbar(props) { // 'props' adalah objek yang berisi semua data yang dikirim
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <Menu as="div" className="relative ml-3">
                            <div >
                                <MenuButton className="relative flex rounded-full bg-yellow-700 text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-red-700">
                                    <span className="absolute -inset-1.5" />
                                    <p className='text-shadow-red-950'>{nav5}</p>
                                </MenuButton>
                            </div>
                        </Menu>
                    </div>
