...
function CTASection() {
    ...
    return (
        <div className="relative bg-gray-800 h-60">
            <div className="absolute inset-0">
                <img className="w-full h-60 object-cover" src={backgroundImageUrl} alt="Tim Study Buddy" />
            ...
            <div className="relative max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="text-center md:text-left">
                        <p className="text-pink-200 font-semibold -mt-15">Masih punya pertanyaan?</p>
                        <h2 className="mt-2 text-3xl font-extrabold text-white tracking-tight sm:text-3xl">
