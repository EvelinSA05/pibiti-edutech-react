function Header(props) {
    const { variant = 'full', title1, title2, h1, h2, h3, h4, h5, h6, h7, h8, v1, v2, v3, v4, picture, link1, link2, link3, link4 } = props;
    ...
    const links = [
        { name: h1, href: link1 }, { name: h2, href: link2 }, { name: h3, href: link3 }, { name: h4, href: link4 },
    ];
    const stats = [
