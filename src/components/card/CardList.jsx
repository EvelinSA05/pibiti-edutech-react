        ...
        <div className="text-center py-16">
            ...
            <div className="mt-8 mb-12 max-w-md mx-auto">
                <input
                    ...
                    className="bg-gray-200 appearance-none border-2 border-gray-900 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                    value={searchTerm}
